        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <div className="space-y-8">
              {[
                {
                  phase: "Months 1-3: Blockchain Fundamentals",
                  topics: ["Cryptography", "Consensus Mechanisms", "Smart Contracts", "Web3 Stack"],
                  project: "Build a decentralized wallet"
                },
                {
                  phase: "Months 4-6: DeFi Development",
                  topics: ["Token Economics", "DeFi Protocols", "AMM Design", "Yield Strategies"],
                  project: "Create a DeFi protocol"
                },
                {
                  phase: "Months 7-9: Advanced Applications",
                  topics: ["NFT Platforms", "DAO Frameworks", "Layer 2 Solutions", "Cross-chain"],
                  project: "Launch a DAO platform"
                },
                {
                  phase: "Months 10-12: Production & Security",
                  topics: ["Security Auditing", "Testing", "Deployment", "Monitoring"],
                  project: "Deploy secure DeFi application"
                }
              ].map((phase, index) => (
                <motion.div 
                  key={index}
                ...
                >
                  <Card className="hover-lift frost-border">
                    <CardHeader>
                      <CardTitle className="text-xl text-forest-green flex items-center gap-3">
                        {phase.phase}
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
