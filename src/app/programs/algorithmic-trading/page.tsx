        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <div className="space-y-8">
              {[
                {
                  phase: "Months 1-3: System Fundamentals",
                  topics: ["C++ Programming", "Market Data Systems", "Network Programming", "Trading APIs"],
                  project: "Build a market data handler"
                },
                {
                  phase: "Months 4-6: Trading Infrastructure",
                  topics: ["Order Management", "Risk Systems", "Database Design", "System Architecture"],
                  project: "Develop order execution engine"
                },
                {
                  phase: "Months 7-9: Performance Engineering",
                  topics: ["Low Latency", "Memory Management", "System Optimization", "Performance Testing"],
                  project: "Optimize trading infrastructure"
                },
                {
                  phase: "Months 10-12: Production Systems",
                  topics: ["Deployment", "Monitoring", "Compliance", "Documentation"],
                  project: "Deploy complete trading system"
                }
              ].map((phase, index) => (
                <motion.div 
                  key={index}
                ...
                >
                  <Card className="hover-lift frost-border">
                    <CardHeader>
                      <CardTitle className="text-xl text-maple-red flex items-center gap-3">
                        {phase.phase}
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
