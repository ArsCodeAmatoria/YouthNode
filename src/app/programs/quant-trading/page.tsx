              ...
              {[
                {
                  ...
                  topics: ["Statistical Methods", "Financial Mathematics", "Python for Finance", "Market Structure"],
                  project: "Build a market data analysis platform"
                },
                {
                  phase: "Months 4-6: Strategy Development",
                  topics: ["Trading Algorithms", "Portfolio Theory", "Risk Management", "Backtesting"],
                  project: "Develop and test trading strategies"
                },
                {
                  phase: "Months 7-9: Advanced Systems",
                  topics: ["High-Frequency Trading", "Market Making", "Options Strategies", "Machine Learning"],
                  project: "Build an automated trading system"
                },
                {
                  phase: "Months 10-12: Professional Practice",
                  topics: ["Production Systems", "Risk Controls", "Compliance", "Team Collaboration"],
                  project: "Deploy strategies in simulated environment"
                }
              ].map((phase, index) => (
                <motion.div 
                  key={index}
