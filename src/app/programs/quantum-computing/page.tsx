...
import { Brain, ArrowRight, Zap, Globe, TrendingUp, Home } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 lg:px-12 text-center">
          ...
          >
            <motion.div variants={fadeInUp} className="mb-6">
              <Brain className="h-16 w-16 mx-auto text-forest-green mb-4" />
            </motion.div>
            <motion.h1 
                ...
                <Card className="h-full hover-lift liquid-glass bg-gradient-to-br from-card to-forest-green-light/15">
                  <CardHeader>
                    <CardTitle className="text-xl text-forest-green-dark flex items-center gap-3">
                      <Zap className="h-6 w-6 text-forest-green" />
                      Quantum Platforms
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="h-full hover-lift liquid-glass bg-gradient-to-br from-card to-icy-blue-light/15">
                  <CardHeader>
                    <CardTitle className="text-xl text-icy-blue-dark flex items-center gap-3">
                      <Globe className="h-6 w-6 text-icy-blue" />
                      Real Applications
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
      ...
      <section className="py-24 bg-muted/30">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          >
              ...
              {[
                ...
                <motion.div key={index} variants={fadeInUp}>
                  <Card className="hover-lift h-full liquid-glass">
                    <CardHeader>
                      <CardTitle className="text-lg text-forest-green">{partner.company}</CardTitle>
                    </CardHeader>
                    <CardContent>
            ...
            <motion.div 
              variants={fadeInUp}
              className="mt-16 text-center bg-gradient-to-r from-forest-green/10 via-icy-blue/10 to-maple-red/10 rounded-3xl p-8"
            >
